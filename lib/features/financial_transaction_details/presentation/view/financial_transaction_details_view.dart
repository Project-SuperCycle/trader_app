...
class FinancialTransactionDetailsView extends StatefulWidget {
  const FinancialTransactionDetailsView({super.key});

  @override
  State<FinancialTransactionDetailsView> createState() =>
      _FinancialTransactionViewState();
}

class _FinancialTransactionViewState extends State<FinancialTransactionDetailsView> {
